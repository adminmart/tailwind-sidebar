            ...
            >
              <div
                className={cn(
                  ...
                  borderRadius,
                  isSelected ? "text-white " : ` dark:text-muted-foreground `,
                ...
                style={{
                  backgroundColor: isSelected
                    ...
                    : undefined,
                  color: isSelected ? "var(--card)" : undefined,
                }}
              >
                {/* Icon */}
                <div className="">{icon ?? <CircleDot size={18} />}</div>

                {/* Text + Badge */}
                {!isCollapse && (
                  <div className="flex items-center justify-between w-full ">
                    <span
                      className={cn(textFontSize, "leading-tight truncate")}
                    >
                      {children}
                    </span>
